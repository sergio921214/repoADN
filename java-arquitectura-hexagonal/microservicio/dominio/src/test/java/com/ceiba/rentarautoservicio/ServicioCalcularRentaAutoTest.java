...
public class ServicioCalcularRentaAutoTest {
    ...
    public void validarNoExistenciaPreviaAuto() {
        ...
        // act - assert
        BasePrueba.assertThrows(() -> servicioCalcularRentaAuto.ejecutar(dtoAuto,1.0,"2020-12-25","2020-12-30"), ExcepcionDuplicidad.class,"El auto NO existe en el sistema");
    }
