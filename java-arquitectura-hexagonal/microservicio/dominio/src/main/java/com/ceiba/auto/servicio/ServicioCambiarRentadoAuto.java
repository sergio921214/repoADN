...
public class ServicioCambiarRentadoAuto {
	...
	/*
	 * private void validarExistenciaPrevia(Auto auto) { boolean existe =
	 * this.repositorioAuto.existe(auto.getPlaca()); if(existe) { throw new
	 * ExcepcionDuplicidad(EL_AUTO_YA_EXISTE_EN_EL_SISTEMA); } }
	 */
}
